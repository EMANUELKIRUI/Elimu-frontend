  ...
  return (
    <LoginLayout>
      <div className="mx-auto max-w-xl px-4 py-20 text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.24em] text-primary">Verify phone</p>
        <h1 className="mt-6 text-4xl font-black tracking-tight text-slate-950">Confirm your phone number</h1>
        <p className="mt-4 text-slate-600">Enter the SMS code we sent to your phone to complete authentication.</p>
